...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			<h2 class="screen-reader-text"><?php _e( 'Comment navigation', '{%= prefix %}' ); ?></h2>
			<div class="nav-links">

				<div class="nav-previous"><?php previous_comments_link( __( 'Older Comments', '{%= prefix %}' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( __( 'Newer Comments', '{%= prefix %}' ) ); ?></div>
